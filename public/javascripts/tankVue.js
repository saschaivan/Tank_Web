...
Vue.component('player-name', {
    ...
    <div class="input-group mb-3 input-name">
        <div id="data_player1">
            <input v-model="player1" id="player1_name" type="text" class="form-control" placeholder="SPIELER 1">
        </div>
        <div id="data_player2">
            <input v-model="player2" id="player2_name" type="text" class="form-control" placeholder="SPIELER 2">
        </div>
        <div id="test">
            <p>Player1: {{ player1 }}</p>
            <p>Player2: {{ player2 }}</p>
